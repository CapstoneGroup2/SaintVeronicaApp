...
<nav class="header navbar fixed-top navbar-expand-lg">
 ...
 <h2 style="font-size: 20px; color: #ff9900;"><i class="glyphicon glyphicon-time" style="color:#3f704d; font-size: 60px;"></i><br/><b>A brief history of the School</b></h2><br/>
 ...
 <td colspan="6" align=""><p style="margin-left:30px; margin-right:50px;"><i style="font-size: 25px; color: #ff9900">Positive</i>, <i>caring relationship based on trust and respect, are at the heart of our philosophy.
