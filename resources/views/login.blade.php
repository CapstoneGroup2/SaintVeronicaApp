...
<body>
    ...
    <nav class="header navbar fixed-top navbar-expand-lg">
        <a class="navbar-brand logo" href="/welcome"><img id="logo-navbar" src="{{ URL::to('/images/logo.jpg') }}">St.
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <span toggle="#password"
                                    class="glyphicon glyphicon-eye-open field-icon toggle-password"></span>
